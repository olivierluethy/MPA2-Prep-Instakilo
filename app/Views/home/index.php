...
?>
<?php if (!$isLoggedIn): ?>
    <div class="mb-6 rounded-xl bg-gradient-to-r from-indigo-600 to-purple-600 p-6 text-white">
...
<?php if (empty($posts)): ?>
    <div class="card flex flex-col items-center gap-2 p-12 text-center">
        ...
        <p class="text-sm text-gray-500 dark:text-gray-400">Sobald es Beiträge gibt, erscheinen sie hier.</p>
    </div>
<?php else: ?>
    <div class="mx-auto grid max-w-xl grid-cols-1 gap-6">
